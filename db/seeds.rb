...
venue_1.offers.create(artist_id: artist_1.id, artist_name: artist_1.name, guarantee: 47000, bonuses: 'contentment', radius_clause: 'No shows in 100 mile radius for next 60 days', total_expenses: 63000, gross_potential: 8000, door_times: '9am-5pm', age_range: '60', merch_split: '70-30', date: '11/23/2018', buyer_id: 1)
venue_1.offers.create(artist_id: artist_2.id, artist_name: artist_2.name, guarantee: 47000, bonuses: 'contentment', radius_clause: 'No shows in 100 mile radius for next 60 days', total_expenses: 63000, gross_potential: 8000, door_times: '9am-5pm', age_range: '60', merch_split: '70-30', date: '10/31/2018', buyer_id: 1)
venue_2.offers.create(artist_id: artist_2.id, artist_name: artist_2.name, guarantee: 47000, bonuses: 'contentment', radius_clause: 'No shows in 100 mile radius for next 60 days', total_expenses: 63000, gross_potential: 8000, door_times: '9am-5pm', age_range: '60', merch_split: '70-30', date: '11/16/2018', buyer_id: 2)
venue_2.offers.create(artist_id: artist_3.id, artist_name: artist_3.name, guarantee: 47000, bonuses: 'contentment', radius_clause: 'No shows in 100 mile radius for next 60 days', total_expenses: 63000, gross_potential: 8000, door_times: '9am-5pm', age_range: '60', merch_split: '70-30', date: '11/16/1931', buyer_id: 2)
