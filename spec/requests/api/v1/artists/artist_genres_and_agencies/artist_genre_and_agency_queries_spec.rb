...
describe 'Arist Genre Endpoints' do
  context '/api/v1/artists/?genre=:genre?agency=stark industries' do
    ...
    it 'returns all artists by specified genre and agency ordered alphabetically' do
      ...
      artist_1 = Fabricate(:artist, name: 'blink-182', agency: 'Stark Enterprises')
      artist_2 = Fabricate(:artist, name: 'ABBA', agency: 'Stark Enterprises')
      artist_3 = Fabricate(:artist, name: 'Creed', agency: 'Hammer Enterprises Enterprises')
      artist_4 = Fabricate(:artist, name: 'Dr Dre', agency: 'Hammer Enterprises')
    ...
    it 'returns all artists by specified genre and agency ordered by popularity' do
      ...
      artist_1 = Fabricate(:artist, popularity: 3, agency: 'Stark Enterprises')
      artist_2 = Fabricate(:artist, popularity: 99, agency: 'Hammer Industries')
      artist_3 = Fabricate(:artist, popularity: 2, agency: 'Hammer Industries')
      artist_4 = Fabricate(:artist, popularity: 84, agency: 'Stark Enterprises')
      ...
      get '/api/v1/artists?genre=rap&agency=Stark%20Enterprises&sort=popularity'
